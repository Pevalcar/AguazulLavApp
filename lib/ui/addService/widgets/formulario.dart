      ...
      child: Column(
        ...
        children: [
          ...
          TextFormField(
            ...
            initialValue:
                ref.watch(vehiculoStateProvider).value?.propietario.name ?? "",
            onChanged: (value) {
              ref.read(vehiculoStateProvider.notifier).modifyPropietario(value);
            },
            decoration: InputDecoration(
              suffixIcon: IconButton(
                  onPressed: () {
                    //TODO search propietario
                  },
                  icon: Icon(
                    Icons.person_search,
                  )),
...
class ClientSearcher extends StatelessWidget {
