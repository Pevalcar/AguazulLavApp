...
part of 'entrada_salida_local_repo.dart';
...
final entradaSalidaLocalDataSourceProvider =
    AutoDisposeProvider<EntradaSalidaLocalDataSource>.internal(
  entradaSalidaLocalDataSource,
  name: r'entradaSalidaLocalDataSourceProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$entradaSalidaLocalDataSourceHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef EntradaSalidaLocalDataSourceRef
    = AutoDisposeProviderRef<EntradaSalidaLocalDataSource>;
String _$entradaSalidaLocalRepositoryHash() =>
    r'7e1e1a287a1fa0274bdc5c463b971bc398c7c326';

/// See also [entradaSalidaLocalRepository].
@ProviderFor(entradaSalidaLocalRepository)
final entradaSalidaLocalRepositoryProvider =
    AutoDisposeProvider<EntradaSalidaLocalRepositoryImpl>.internal(
  entradaSalidaLocalRepository,
  name: r'entradaSalidaLocalRepositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$entradaSalidaLocalRepositoryHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
