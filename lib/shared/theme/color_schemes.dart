...
class MaterialTheme {
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      surfaceTint: Color(0xff006a67),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff24817e),
      ...
      tertiaryFixedDim: Color(0xff475e79),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      inversePrimary: Color(0xffa6fbf7),
      ...
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff162e47),
      onTertiaryFixedVariant: Color(0xffffffff),
      surfaceDim: Color(0xffd5dbda),
      surfaceBright: Color(0xfff4fbf9),
      surfaceContainerLowest: Color(0xffffffff),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryFixedDim: Color(0xffb1c8e8),
      onTertiaryFixedVariant: Color(0xff213851),
      surfaceDim: Color(0xff0e1514),
      surfaceBright: Color(0xff343a3a),
      surfaceContainerLowest: Color(0xff090f0f),
      surfaceContainerLow: Color(0xff161d1c),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      primaryContainer: Color(0xff84d9d5),
      onPrimaryContainer: Color(0xff000000),
      secondary: Color(0xffeafffd),
      onSecondary: Color(0xff000000),
      secondaryContainer: Color(0xffb5d0ce),
      onSecondaryContainer: Color(0xff000000),
      tertiary: Color(0xfffafaff),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xffb5cdec),
      onTertiaryContainer: Color(0xff000000),
      ...
      primaryFixed: Color(0xffa1f6f2),
      onPrimaryFixed: Color(0xff000000),
      primaryFixedDim: Color(0xff84d9d5),
      onPrimaryFixedVariant: Color(0xff001a19),
      secondaryFixed: Color(0xffd0ecea),
      onSecondaryFixed: Color(0xff000000),
      secondaryFixedDim: Color(0xffb5d0ce),
      onSecondaryFixedVariant: Color(0xff011a19),
      tertiaryFixed: Color(0xffd9e8ff),
      onTertiaryFixed: Color(0xff000000),
      tertiaryFixedDim: Color(0xffb5cdec),
